...
# ---------------------------
#
# header of FASTA file has to follow the specification:
#
...
# or
#
# >ATCG00500.1 | [Arabidopsis thaliana] | [Eukaryota; Viridiplantae; Streptophyta; Streptophytina; Embryophyta; Tracheophyta; Euphyllophyta; Spermatophyta; Magnoliophyta; eudicotyledons; core eudicotyledons; rosids; malvids; Brassicales; Brassicaceae; Camelineae; Arabidopsis]
#
# for A.thaliana
...
# perl createPsMap.pl -i Athaliana_peptide.fa -d phyloBlastDb.fa -p BLAST_Athaliana -r athaliana_blast_results -t 30 -a 64
...
my $refOrg = "Athaliana_tair10_peptide.fa";
my $db = "BLAST_DB/phylostratigraphyBlastDb.fa";
...
# makes it easier to restart at a specific seqeunces if
...
for my $geneIndex (0..$geneNumber){
    ...
    print "\nGene ->".$gene->display_id." --- ".$geneIndex+1." of ".$geneNumber."\n";
...
##                                                ##
## 1.Arg: name of database without extension      ##
## 2.Arg: gene Bio::Seq - object                  ##
## 3.Arg: mysql file name                         ##
## 4.Arg: mysql table name                        ##
## 5.Arg: name of reference organism              ##
## 6.Arg: number of threads for BALST searchs     ##
